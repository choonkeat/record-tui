...
// tocEntries optionally adds a floating TOC panel for navigation.
func RenderPlaybackHTML(frames []PlaybackFrame, title string, footerLink FooterLink, tocEntries []TOCEntry) (string, error) {
